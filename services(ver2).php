      ...
      <div class="best-services"> 
        ...
        <div class="container">
          <ul class="row list">
            ...
            <!-- Analytics -->
            <li class="col-md-6" data-content="#colio_c1">
              <article class="thumb"> <a class="button colio-link" href="#"> <img src="images/portfolio/img-4.jpg">
                <h5>Analytics</h5>
            ...
            <!-- Storage -->
            <li class="col-md-6" data-content="#colio_c2">
            ...
            <!-- Analytics -->
            <li class="col-md-6" data-content="#colio_c3">
            ...
            <!-- Storage -->
            <li class="col-md-6" data-content="#colio_c4">
              ...
              <div class="services-in">
                <ul class="row">
                  ...
                  <li class="col-sm-4">
                    ...
                    <a href="#." class="btn btn-1 btn-sm">Read More <i class="fa fa-caret-right"></i></a> </li>
