...
?>
  ...
  <!-- SUB BANNER -->
  <section class="sub-bnr" style="background:url(images/bg/revenues-bg.jpg) no-repeat" data-stellar-background-ratio="0.5">
    <div class="position-center-center">
      <div class="container">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">2015 annual report</li>
        </ol>
      </div>
    </div>
  </section>
                ...
                <ul class="row">
                  ...
                  <li class="col-sm-6">
                    <article class="book-1">
                      <div class="row">
                        <div class="col-sm-6"> <img class="img-responsive" src="images/book-1.png" alt="" > </div>
                        <div class="col-sm-6 no-padding-left">
                          <h3>2015</h3>
                          <h6>Annual Report</h6>
                          <p>Donec venenatis turp 
                            vel hendrerit intedum
                            pede dipae budipus. </p>
                          <a href="#." class="btn btn-1 margin-top-30"> download docx <i class="fa fa-caret-right"></i></a> </div>
                      </div>
                    </article>
                  </li>
                  ...
                  <li class="col-sm-6">
                    <article class="book-2">
                      <div class="row">
                        <div class="col-sm-6"> <img class="img-responsive" src="images/book-2.png" alt="" > </div>
                        <div class="col-sm-6 no-padding-left">
                          <h3>2014</h3>
                          <h6>Annual Report</h6>
                          <p>Donec venenatis turp 
                  ...
                  <li class="col-sm-6">
                    <article class="book-3">
                      <div class="row">
                        <div class="col-sm-6"> <img class="img-responsive" src="images/book-3.png" alt="" > </div>
                        <div class="col-sm-6 no-padding-left">
                          <h3>2013</h3>
                          <h6>Annual Report</h6>
                          <p>Donec venenatis turp 
                  ...
                  <li class="col-sm-6">
                    <article class="book-4">
                      <div class="row">
                        <div class="col-sm-6"> <img class="img-responsive" src="images/book-4.png" alt="" > </div>
                        <div class="col-sm-6 no-padding-left">
                          <h3>2012</h3>
                          <h6>Annual Report</h6>
                          <p>Donec venenatis turp 
                  ...
                  <!-- Book 5 -->
                  <li class="col-sm-6">
                    <article class="book-5">
                      <div class="row">
                        <div class="col-sm-6"> <img class="img-responsive" src="images/book-5.png" alt="" > </div>
                        <div class="col-sm-6 no-padding-left">
                          <h3>2011</h3>
                          <h6>Annual Report</h6>
                          <p>Donec venenatis turp 
                  ...
                  <!-- Book 6 -->
                  <li class="col-sm-6">
                    <article class="book-6">
                      <div class="row">
                        <div class="col-sm-6"> <img class="img-responsive" src="images/book-6.png" alt="" > </div>
                        <div class="col-sm-6 no-padding-left">
                          <h3>2010</h3>
                          <h6>Annual Report</h6>
                          <p>Donec venenatis turp 
