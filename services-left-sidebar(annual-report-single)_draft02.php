      ...
      <div class="container">
        <div class="row"> 
          ...
          <div class="col-md-9">
            ...
            <div class="cart-histori" id="monthly-average-temperature"></div>
            
            <!-- USD TO ERU -->
            <div class="cart-histori margin-top-100" id="usd-to-eur"></div>
            
            <!-- Scatter -->
            <div class="cart-histori margin-top-100" id="scatter"></div>
            
            <!-- areaspline -->
            <div class="cart-histori margin-top-100" id="areaspline"></div>
            
            <!-- Temperatures -->
            <div class="cart-histori margin-top-100" id="temperatures"></div>
