      ...
      <div class="sticky">
        <div class="container"> 
          ...
          <ul class="nav ownmenu">
            ...
            <li> <a href="about.html">About </a> </li>
            <li class="active"> <a href="services(ver1).html">Services </a>
              <ul class="dropdown">
                <li> <a href="services(ver1).html">Services Version 1</a> </li>
                <li> <a href="services(ver2).html">Services Version 2</a> </li>
                <li> <a href="services(ver3).html">Services Version 3</a> </li>
...
?>
  ...
  <!-- SUB BANNER -->
  <section class="sub-bnr" style="background:url(images/bg/media-bg.jpg) no-repeat" data-stellar-background-ratio="0.5">
    <div class="position-center-center">
      <div class="container">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">media relations</li>
        </ol>
      </div>
    </div>
  </section>
        ...
        <div class="row"> 
          ...
          <div class="col-md-3">
            <div class="side-bar-revenues"> 
              ...
              <!-- Company & Services -->
              <h5 class="side-heading">Company & Services</h5>
              
              <!-- Key Financials -->
              <h6 class="head"><a data-toggle="collapse" href="#key" aria-expanded="false"><i class="fa fa-bar-chart"></i> Key Financials</a></h6>
              ...
              <!-- Key Financials -->
              <h6 class="head"><a data-toggle="collapse" href="#Stories" aria-expanded="false"><i class="fa fa-comments-o"></i> Stories</a></h6>
              ...
              <!-- Media Relations -->
              <h6 class="head"><a data-toggle="collapse" href="#media" aria-expanded="false"><i class="fa fa-globe"></i> Media Relations</a></h6>
              ...
              <!-- Key Financials -->
              <h6 class="head"><a data-toggle="collapse" href="#copo" aria-expanded="false"><i class="fa fa-rocket"></i> Corporate Solutions</a></h6>
              ...
              <!-- Key Financials -->
              <h6 class="head"><a data-toggle="collapse" href="#comp" aria-expanded="false"><i class="fa fa-bank"></i> Company History</a></h6>
              ...
              <!-- Key Financials -->
              <h6 class="head"><a data-toggle="collapse" href="#men" aria-expanded="false"><i class="fa fa-users"></i> Our People</a></h6>
              ...
              <!-- Brochures -->
              <div class="broc"> <img class="img-responsive" src="images/down-img-1.jpg" alt="" > <a href="#." class="icon-down"><i class="fa fa-download"></i></a> <a href="#." class="icon-file"><i class="fa fa-file-pdf-o"></i> Portfolio .DOC</a> </div>
              
              <!-- Brochures -->
              <div class="broc"> <img class="img-responsive" src="images/down-img-2.jpg" alt="" > <a href="#." class="icon-down"><i class="fa fa-download"></i></a> <a href="#." class="icon-file"><i class="fa fa-file-pdf-o"></i> Annual Report .PDF</a> </div>
            </div>
          </div>
            ...
            <section class="portfolio padding-top-0 padding-bottom-20"> 
              ...
              <div class="ajax-work"> 
                ...
                <div class="cbp-item col-sm-3 ana dial growth">
                  <article class="item"><img class="img-responsive" src="images/media-img-1.jpg" alt="" > 
                    <!-- Hover -->
                ...
                <div class="cbp-item col-sm-3  ana dial sec storage">
                  <article class="item"><img class="img-responsive" src="images/media-img-2.jpg" alt="" > 
                    <!-- Hover -->
                    <div class="over-detail"> 
                      <!-- Link -->
                      <div class="top-detail"> <a href="ajax-work/project1.html" class="cbp-singlePage"><i class="fa fa-link"></i> </a> <a href="images/media-img-2.jpg" class="cbp-lightbox" data-title=""><i class="icon-magnifier"></i></a> </div>
                      <!-- TITTLE HEADING --> 
                ...
                <!-- ITEMS -->
                <div class="cbp-item col-sm-6 ana sec storage">
                  <article class="item"><img class="img-responsive" src="images/media-img-3.jpg" alt="" > 
                    <!-- Hover -->
                    <div class="over-detail"> 
                      <!-- Link -->
                      <div class="top-detail"> <a href="ajax-work/project1.html" class="cbp-singlePage"><i class="fa fa-link"></i> </a> <a href="images/media-img-3.jpg" class="cbp-lightbox" data-title=""><i class="icon-magnifier"></i></a> </div>
                    </div>
                  </article>
                </div>
                
                <!-- ITEMS -->
                <div class="cbp-item col-sm-6 sec storage">
                  <article class="item"><img class="img-responsive" src="images/media-img-4.jpg" alt="" > 
                    <!-- Hover -->
                    <div class="over-detail"> 
                      <!-- Link -->
                      <div class="top-detail"> <a href="ajax-work/project1.html" class="cbp-singlePage"><i class="fa fa-link"></i> </a> <a href="images/media-img-4.jpg" class="cbp-lightbox" data-title=""><i class="icon-magnifier"></i></a> </div>
                    </div>
                  </article>
                </div>
                
                <!-- ITEMS -->
                <div class="cbp-item col-sm-6 ana sec">
                  <article class="item"><img class="img-responsive" src="images/media-img-5.jpg" alt="" > 
                    <!-- Hover -->
                    <div class="over-detail"> 
                      <!-- Link -->
                      <div class="top-detail"> <a href="ajax-work/project1.html" class="cbp-singlePage"><i class="fa fa-link"></i> </a> <a href="images/media-img-5.jpg" class="cbp-lightbox" data-title=""><i class="icon-magnifier"></i></a> </div>
                      <!-- TITTLE HEADING -->
                ...
                <div class="cbp-item col-sm-3 ana dial direc">
                  <article class="item"><img class="img-responsive" src="images/media-img-6.jpg" alt="" > 
                    <!-- Hover -->
                    <div class="over-detail"> 
                      <!-- Link -->
                      <div class="top-detail"> <a href="ajax-work/project1.html" class="cbp-singlePage"><i class="fa fa-link"></i> </a> <a href="images/media-img-6.jpg" class="cbp-lightbox" data-title=""><i class="icon-magnifier"></i></a> </div>
                    </div>
                  </article>
                </div>
                <div class="cbp-item col-sm-3 ana dial direc">
                  <article class="item"><img class="img-responsive" src="images/media-img-7.jpg" alt="" > 
                    <!-- Hover -->
                    <div class="over-detail"> 
                      <!-- Link -->
                      <div class="top-detail"> <a href="ajax-work/project1.html" class="cbp-singlePage"><i class="fa fa-link"></i> </a> <a href="images/media-img-7.jpg" class="cbp-lightbox" data-title=""><i class="icon-magnifier"></i></a> </div>
                    </div>
                  </article>
                </div>
                <div class="cbp-item col-sm-6 ana dial direc">
                  <article class="item"><img class="img-responsive" src="images/media-img-8.jpg" alt="" > 
                    <!-- Hover -->
                    <div class="over-detail"> 
                      <!-- Link -->
                      <div class="top-detail"> <a href="ajax-work/project1.html" class="cbp-singlePage"><i class="fa fa-link"></i> </a> <a href="images/media-img-8.jpg" class="cbp-lightbox" data-title=""><i class="icon-magnifier"></i></a> </div>
                    </div>
                  </article>
                </div>
                <div class="cbp-item col-sm-6 ana dial direc">
                  <article class="item"><img class="img-responsive" src="images/media-img-9.jpg" alt="" > 
                    <!-- Hover -->
                    <div class="over-detail"> 
                      <!-- Link -->
                      <div class="top-detail"> <a href="ajax-work/project1.html" class="cbp-singlePage"><i class="fa fa-link"></i> </a> <a href="images/media-img-9.jpg" class="cbp-lightbox" data-title=""><i class="icon-magnifier"></i></a> </div>
                    </div>
                  </article>
                </div>
              </div>
